...
const experiences: Experience[] = [
  {
    ...
    description:
      'Worked on building web applications using React and Node.js, and collaborated with cross-functional teams.',
  ...
  },
  {
    ...
    description:
      'Developed features for the company’s flagship product and gained experience in software development practices.',
